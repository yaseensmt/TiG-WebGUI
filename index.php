...
<html lang="en">
  <head>
    ...
    <title>TiG WiFi Control Panel</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SMT Wifi Portal v1.0</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">
              <img class="logo" src="img/raspAP-logo.png" width="45" height="45"> TiG
            </h1>
          </div>
        </div><!-- /.row -->
